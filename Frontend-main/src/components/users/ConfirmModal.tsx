...
<button className="flex-1 bg-white border border-gray-300 rounded-md text-gray-700 py-2 font-semibold cursor-pointer" onClick={onClose} >
Cancel
</button>
<button className="flex-1 bg-red-600 text-white rounded-md py-2 font-semibold cursor-pointer" onClick={onClose} >
Confirm
</button>
</div>
</div>
